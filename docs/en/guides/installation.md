...
- Download the installer for your platform (macOS / Windows) from [Releases](https://github.com/next-open-ai/openbot/releases).
- Install and launch OpenBot, then set API Key and default model in the UI.
