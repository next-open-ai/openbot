...
Welcome to OpenBot. This documentation covers installation, configuration, and advanced features.
...
| [Agent Configuration](configuration/agents.md) | Local/Coze/OpenBot/OpenCode execution, model and workspace |
...
| Document | Description |
|----------|-------------|
| [Proxy Mode and Multi-Node](features/proxy-mode.md) | Coze, OpenBot, OpenCode proxy and config |
