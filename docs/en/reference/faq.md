...
**Q: Can channel default agent be Coze / OpenBot / OpenCode?**  
...
A: Run OpenBot Gateway on another machine; on this machine set the agent execution to OpenBot and set baseUrl (and optional apiKey). See [Proxy mode](../features/proxy-mode.md).
