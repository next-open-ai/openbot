...
欢迎使用 OpenBot。本文档提供从安装、配置到进阶功能的完整使用说明。
...
| [智能体配置](configuration/agents.md) | 本机/Coze/OpenBot/OpenCode 执行方式、模型与工作区 |
...
| 文档 | 说明 |
|------|------|
| [代理模式与多节点协作](features/proxy-mode.md) | Coze、OpenBot、OpenCode 代理与配置要点 |
